  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
        ...
        {/* Newsletter Section */}
        <div className="mt-12 md:mt-20 max-w-2xl mx-auto p-6 md:p-12 border border-white/10 bg-white/5 space-y-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <input 
              ...
              className="bg-transparent border border-white/20 px-4 py-3 text-sm focus:outline-none focus:border-primary flex-1"
            />
