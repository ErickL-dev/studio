...
export function Hero() {
  return (
    <section className="relative min-h-[70vh] md:min-h-[85vh] flex items-center pt-24 md:pt-20 overflow-hidden nueva-ola-grid">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto space-y-8 md:space-y-12 text-center">
          <div className="space-y-6">
            <h2 className="text-primary font-headline uppercase tracking-[0.3em] text-[10px] md:text-xs font-bold animate-in fade-in slide-in-from-bottom-2 duration-700">
              EST. 2026 / TRUJILLO PERÚ
            </h2>
            <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-headline font-bold uppercase leading-[0.85] tracking-tighter animate-in fade-in slide-in-from-bottom-4 duration-1000">
              Kuro <br />
          ...
          <div className="relative">
            ...
            <p className="text-base md:text-xl text-muted-foreground pt-8 leading-relaxed max-w-2xl mx-auto animate-in fade-in duration-1000 delay-300">
              Tu dosis diaria de estilo. Encuentra la mejor calidad que buscas para el día a día. Una nueva ola de moda urbana.
            </p>
          </div>
